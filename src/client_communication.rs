...
async fn get_client_ip_from_sheets(
    ...
    let range = "ClientsOnline!A:B"; // Two columns: client_id and client_ip
...
async fn readd_client_to_dos(
    ...
    if client_exists {
        ...
        let update_url = format!(
            "https://sheets.googleapis.com/v4/spreadsheets/{}/values/ClientsOnline!A{}:B{}?valueInputOption=RAW",
            spreadsheet_id,
...
async fn remove_client_from_sheet(
    ...
    let spreadsheet_id = "12SqSHonSlPVo8JXcj2Or1cmXOlEPpIjxQ64yZLOHZIg";
    let range = "ClientsOnline!A:C"; // Adjust this range to match your sheet structure.
...
async fn handle_show_active_clients_request(
    ...
    let spreadsheet_id = "12SqSHonSlPVo8JXcj2Or1cmXOlEPpIjxQ64yZLOHZIg";
    let range = "ClientsOnline!A:B"; // Two columns: client_id and ip
